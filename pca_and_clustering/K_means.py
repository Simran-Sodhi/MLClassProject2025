...
def spherical_kmeans(X, k, max_iter=100, tol=1e-4):
    ...
    """
    # Normalize the input data so that cosine similarity equals the dot product.
    ...
    # Ensure centroids are normalized (should already be true).
    ...
    for iteration in range(max_iter):
        ...
        # If no label changes, the algorithm has converged.
